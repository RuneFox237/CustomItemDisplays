...
namespace RuneFoxMods.CustomItemDisplays
{
  ...
  using RuneFoxMods.TemplateHelpers;
  using System;
  ...
  public partial class CustomItemDisplayTemplate : CustomItemDisplayTemplateBase
  {
    /// <summary>
    ...
    public virtual string TransformText()
    {
      this.Write("using RoR2;\r\nusing System;\r\nusing System.Collections.Generic;\r\nusing UnityEngine;" +
              ...
              "eSpace and SkinName are generated from SkinDef Generator\r\nnamespace ");
...
");
      ...
      {
        this.Write("      Dictionary<string, ItemDisplayRule[]> ");
        this.Write(this.ToStringHelper.ToStringWithCulture(skin.skinDef.name.ToUpperCamelCase()));
        this.Write("Displays = new Dictionary<string, ItemDisplayRule[]>();\r\n");
      }
      this.Write(@"      /// Local Declerations
      //////////////////////////////////////////////////////////////////////////////////////////
      //////////////////////////////////////////////////////////////////////////////////////////
      /// Local funcitons
...
");
      foreach (var skin in info.Skins)
      {
        this.Write("        _CustomItemDisplayManager.CustomDisplays.Add(\"");
      ...
      this.Write("      }\r\n\r\n      //Custom format for KEB\'s item display helper\r\n      //new ItemD" +
              "isplayRule{childName={childName}, localPos = {localPos:4}, localAngles = {localA" +
              "ngles:4}, localScale = {localScale:4}}\r\n      void AddDisplayRules()\r\n      {\r\n");
      foreach (var skin in info.Skins)
      {
        //////////////////////////////////////////////////////////////
        // Base Items
        foreach (var baseItem in skin.BaseItemDisplays)
        {
          this.Write("        ");
          this.Write(this.ToStringHelper.ToStringWithCulture(skin.skinDef.name.ToUpperCamelCase()));
          this.Write("Displays.Add(\"");
          this.Write(this.ToStringHelper.ToStringWithCulture(baseItem.ItemName));
          this.Write("\", new ItemDisplayRule[]\r\n        {");
          for (int i = 0; i < baseItem.DisplayList.Count; i++)
          {
            var display = baseItem.DisplayList[i];
            this.Write("\r\n          new ItemDisplayRule {childName = \"");
            this.Write(this.ToStringHelper.ToStringWithCulture(display.childName));
            this.Write("\", localPos = ");
            this.Write(this.ToStringHelper.ToStringWithCulture(Helpers.PrintVector3(display.localPos)));
            this.Write(", localAngles = ");
            this.Write(this.ToStringHelper.ToStringWithCulture(Helpers.PrintVector3(display.localAngle)));
            this.Write(", localScale = ");
            this.Write(this.ToStringHelper.ToStringWithCulture(Helpers.PrintVector3(display.localScale)));
            this.Write("}");
            if (i < baseItem.DisplayList.Count - 1)
            {
              this.Write(",");
            }
          }
  ...
  /// </summary>
  [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "16.0.0.0")]
  public class CustomItemDisplayTemplateBase
  {
    #region Fields
